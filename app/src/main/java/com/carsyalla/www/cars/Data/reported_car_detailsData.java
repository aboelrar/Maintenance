...
public class reported_car_detailsData implements reportedCar_details.interfaces.Model {
    apis apis=new apis();
    int count=-2;
    @Override
    public String getdata(final Context context, final TextView brand, final TextView plate_num, final TextView notes, final TextView brand1, final TextView model1, final TextView address, String reported_car_id, final ViewPager viewPager, final CircleIndicator circleIndicator) {
        String stolen_car_details=apis.reportedCarDetails+"/"+reported_car_id;
