...
public class searchCenter {
    ...
    String discount;
    public searchCenter(boolean fav) {
        this.fav = fav;
    }

    public searchCenter(String id, String name, String address, String image, int favNum, int rating,ArrayList<icons>mylist,String discount,String Special) {
        this.id = id;
        Name = name;
        Address = address;
        Image = image;
