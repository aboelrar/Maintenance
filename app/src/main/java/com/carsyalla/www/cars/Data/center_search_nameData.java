...
public class center_search_nameData implements center_search_name.interfaces.Model {
    apis apis=new apis();
    @Override
    public ArrayList getdata(final RecyclerView recyclerView, final Context context, String name, String user_id, int pageNum, final favourite.interfaces.View view, final ProgressBar loading, final GifImageView gifImageView, final TextView nodata) {
        final ArrayList<searchCenter>arrayList=new ArrayList<searchCenter>();
        String search_url=apis.center_search_byName+"/"+name+"/"+user_id+"/"+pageNum;
